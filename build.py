...
YAML_PAGE_MAP = {
    ...
    'en/deities.html':         ('en', 'deidades'),
    'fr/deities.html':         ('fr', 'deidades'),
    'de/deities.html':         ('de', 'deidades'),
    'zh/deities.html':         ('zh', 'deidades'),
    'en/weekly-pujas.html':    ('en', 'pujas-semanales'),
    'fr/weekly-pujas.html':    ('fr', 'pujas-semanales'),
    'de/weekly-pujas.html':    ('de', 'pujas-semanales'),
    'zh/weekly-pujas.html':    ('zh', 'pujas-semanales'),
}
